cli::test_that_cli("assert_packages_installed() works", config = "plain", {
  ...
  expect_error(assert_packages_installed(c("notapackage123", "notapackage456")), "Missing the required packages: notapackage123, notapackage456. Please install and try again.", fixed = TRUE)
